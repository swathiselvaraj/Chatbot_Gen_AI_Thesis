        ...
        if is_followup:
            ...
            if referenced_option is not None and options:
                try:
                    ...
                    context_parts.append(
                        f"Option Being Questioned: Option {option_num} ({referenced_option})"
                    )
                except ValueError:
                    pass
                ...
                - Recommended Option: {original_rec['text'] if original_rec else 'None'}
                - Option Being Questioned: Option {option_num} ({referenced_option})
                - User Input: {follow_up_question or question}
